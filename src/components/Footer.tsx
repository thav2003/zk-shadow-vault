...
const footerLinks = {
  Product: ["Features", "Architecture", "Use Cases", "Pricing"],
...
const Footer = () => {
  return (
    <footer className="relative border-t border-border/50 bg-card/20">
      {/* Grid pattern */}
      <div className="absolute inset-0 bg-circuit-pattern opacity-3" />
      ...
      <div className="container relative px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground">
              The Anonymous Fund Engine. <br />
              Privacy-first infrastructure for on-chain finance.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-border/50">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            © 2025 ZKFund. All rights reserved.
          </p>
